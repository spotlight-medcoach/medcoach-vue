...
<div style="width: 400px;">
  <p class="text-center">Le enviaremos un email con un link para recuperar su contraseña</p>
  ...
  <div class="text-center link pointer" @click="goToLogin">Regresar al login</div>
</div>
</template>
<script>
export default {
  name: 'new-recovery-password',
  data () {
    return {
      user: '',
      busy: false
