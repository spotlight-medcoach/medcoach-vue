    ...
    <b-row v-else ref="mainContainer" id="mainContainer" :style="{'height': height}">
      ...
      <b-col :cols="subtopics_cols" class="h-100">
        <b-row class="row-search">
          <b-col cols="12">
            <div class="input-group md-form form-sm form-2 pl-0" id="search-input">
              <input class="form-control my-0 py-1 lime-border" type="text" v-model.trim="search" @focus="onFocusSearch" @blur="onBlurSearch">
        ...
        <b-row class="mt-3" style="height: 90%" v-show="!isSearch">
          ...
          <b-col cols="9" class="h-100"><ManualsStudyGuide :isNotes="isNotes"/></b-col>
        </b-row>
      </b-col>
    </b-row>
  </b-container>
