<template>
  <div id="profile">
    ...
    <div v-if="user" class="card-profile">
      <div class="card-profile-content">
        <p class="user-name mb-16px ml-3">
          {{ `${user.name} ${user.last_name}` }}
        </p>
        <ul>
          <li v-if="pageName != 'diagnostic_test'" class="mb-10px">
            <nuxt-link
              to="/settings"
              class="link link-default link-no-decoration"
            >
              Modificar Perfil
            </nuxt-link>
          </li>
